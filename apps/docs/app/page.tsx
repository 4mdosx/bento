...
export default function Home() {
  return <main>
    ...
    <section className="grid" aria-label="Bento 的组成"><article className="card"><span className="number">01</span><h3>Host 管理状态</h3><p>统一处理请求、取消、错误、选择和乐观更新。</p></article><article className="card"><span className="number">02</span><h3>View 提供源码</h3><p>应用可以直接修改组件结构和样式。</p></article><article className="card"><span className="number">03</span><h3>文档包含验证工具</h3><p>在同一站点阅读文档、编辑组件配置和检查预览。</p></article></section>
  </main>
}
