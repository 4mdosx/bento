...
export default function GettingStarted() {
  return <main className="docs-layout"><aside className="toc"><strong>开始使用</strong><a href="#install">安装</a><a href="#model">Model 与 Action</a><a href="#render">连接 View</a><a href="#verify">验证</a></aside><article className="prose">
    ...
    <section id="install"><h3>1. 初始化并生成 View</h3><pre><code>{install}</code></pre></section>
