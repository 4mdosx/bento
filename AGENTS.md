...
Start with `apps/docs/content/docs/agent/index.md`. Choose a documented Use Case before choosing files. Business state and effects belong in a Host; editable presentation belongs in Registry-delivered source.
